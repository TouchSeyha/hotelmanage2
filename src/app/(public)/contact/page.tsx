            ...
            <section className="border-base-200 from-primary/5 via-secondary/5 to-accent/5 relative overflow-hidden border-b bg-linear-to-br py-16">
                ...
                <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
                    ...
                    <p className="text-base-content/70 mt-4">
                        We confirm transfers, suites, and rituals manually so you never worry about
                        payments or timing.
                    </p>
                </div>
            </section>
                ...
                <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                    <div className="glass-panel rounded-3xl p-8">
                        ...
                        <p className="text-base-content/60 text-sm">
                            Stylists reply with suite pairings, hydro circuit times, or help with
                            in-house stays.
                        </p>
                        ...
                        <div className="card border-base-200 bg-base-100 rounded-3xl border p-6">
                            ...
                            <div className="mt-4 space-y-4">
                                {propertyDetails.map((detail) => (
                                    <div
                                        key={detail.label}
                                        className="border-base-200/70 rounded-2xl border p-4"
                                    >
                                        {detail.icon && (
